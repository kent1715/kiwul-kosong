    ...
    try {
      ...
      const response = await fetch(url, {
        ...
        body: JSON.stringify({
          ...
          // Kirim frame count dengan beberapa kemungkinan nama field karena
          // beda provider WAN pakai beda key. fps 16 -> 5 detik = 81 frames
          // (ditambah 1 frame untuk i2v context). Kalau provider ignore duration,
          // salah satu field ini kemungkinan besar diterima.
