...
export async function POST(
  ...
  try {
    ...
    const savedFileName = filePath.split(/[\\/]/).pop() || `${sceneId}_background.png`;

    // API path for frontend (cache-busting via ?v=timestamp, same pattern as image route)
