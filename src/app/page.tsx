...
const fixFiles = [
  ...
  { name: 'CHARACTER-REFERENCE-PROMPTS.md', desc: 'Prompt generate 4 karakter reference (Arman, Pak Karto, Bowo, Maya) - BARU', icon: FileText, href: '/kiwul-fixes/CHARACTER-REFERENCE-PROMPTS.md', size: '10 KB', highlight: true },
